...
for i = 1:N
    ...
    set(fig1.CurrentAxes ,'CLim',[7.14683052857818e-10 0.1],'Colormap',...
    ...
    savefig(cell2mat(['Waterfall_SvsF-',conf(i).conf.punta,'.fig'])); % cell2mat(['Collezione_Coerenza_',conf.campione,'_',conf.piastra]
