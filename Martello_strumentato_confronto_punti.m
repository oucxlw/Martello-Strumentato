...
legend('10 N','20 N','100 N','200 N','20 N bis')
...
plot(f_fft, angle(mean(FFT_K_1,2)),'color',string(colore(1,:)),'LineWidth', 2)
plot(f_fft, angle(mean(FFT_K_2,2)),'color',string(colore(2,:)),'LineWidth', 2)
plot(f_fft, angle(mean(FFT_K_3,2)),'color',string(colore(3,:)),'LineWidth', 2)
plot(f_fft, angle(mean(FFT_K_4,2)),'color',string(colore(4,:)),'LineWidth', 2)
%plot(f_fft, angle(mean(FFT_K_5,2)),'color',string(colore(5,:)),'LineWidth', 2)

xlim([20 5000]),% yticks([-180 -90 0 90 180]),grid on
set(gca, 'XScale', 'log')
