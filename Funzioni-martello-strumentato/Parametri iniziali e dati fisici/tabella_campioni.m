...
campioni_mass = [0.658; 0.634; 0.639; 0.607; 0.541; 0.586; 1; 1; 0.5531; 0.3926; 0.1461; 0.123; 0.6128; 1.446; 0.0383;  0.0705; 0.1064; 1; 1; 1; 1; 1; 1];
campioni_h =    [0.037; 0.035; 0.036; 0.032; 0.029; 0.032; 0.020; 1; 0.031; 0.027;  0.031;  0.031; 0.039;  0.09;  0.005;    0.01;  0.015; 0.045; 0.045; 0.045; 0.019; 0.05; 0.04];
