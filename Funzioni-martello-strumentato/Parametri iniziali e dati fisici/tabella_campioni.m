...
campioni_mass = [1; 1; 0.5531; 0.3926; 0.1461; 0.123; 0.6128; 1.446; 0.0383;  0.0705; 0.1064; 1; 1; 1; 1; 1; 1];
campioni_h =    [0.020; 1; 0.031; 0.027;  0.031;  0.031; 0.039;  0.09;  0.005;    0.01;  0.015; 0.045; 0.045; 0.045; 0.019; 0.05; 0.04];
campioni_d =    [2*sqrt(0.50*0.24/pi); 1; 0.1;   0.099;  0.097;  0.097;   0.1;   0.1;  2*sqrt(0.098*0.096/pi);...
...
campioni.Properties.RowNames={'slab2','calibrazione','c0','c1', 'c2', 'c2b', 'c3','c4','polipropilene','teflon','PVC',...
