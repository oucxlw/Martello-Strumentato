function [dat_cut] = taglio_validazione(dat, inizio_misura_1, fine_misura_1, inizio_misura_2, fine_misura_2)
for i = 1:3
    dat_cut(i).transiti = dat(i).transiti;
...
dat_cut(7).transiti = dat(i).transiti;
dat_cut(8).transiti = dat(i).transiti;
