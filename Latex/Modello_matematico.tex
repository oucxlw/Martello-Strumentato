\documentclass[12pt,a4paper]{article}
 ...
 \section{Tre masse e tre molle smorzate}
 	...
 	\subsection[Lagrangiana]{Trattazione lagrangiana}
		...
		\end{vmatrix}
		\end{gather}
		Siccome la misura dell'accelerazione viene effettuata sulla massa m\ped1 ci interessa risolvere il sistema in funzione della coordinata $x\ped{1}$. A tal proposito ipotizziamo che il sistema venga sottoposto a una forza esterna $F(t) $. In generale se la forza $F(t)$ appartiene a  $L^2$ puo essere espressa in funzione di una base dello spazio $L^2(R)$, ad esempio $e^{i\omega t}$ .
